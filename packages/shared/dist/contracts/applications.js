...
const optionalText = (max = 5_000) => z.string().trim().max(max).optional().nullable();
const optionalUrl = z
...
const applicationBaseSchema = z
    ...
    .strict();
const salaryRangeIsValid = (value) => value.salaryMin == null ||
    value.salaryMax == null ||
    value.salaryMin <= value.salaryMax;
export const applicationCreateSchema = applicationBaseSchema.refine(salaryRangeIsValid, {
